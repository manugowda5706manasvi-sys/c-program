...
int main() {
    ...
    while (1) {
        ...
        printf("\n--- 2D Graphics Editor ---\n");
        displayCanvas();
        printf("\n1. Add Circle\n2. Add Rectangle\n3. Add Line\n4. Add Triangle\n5. Delete Object\n6. Modify Object\n7. List Objects\n8. Clear All Objects\n9. Toggle View Mode (Current: %s)\np. Pan\nz. Zoom In\nZ. Zoom Out\nq. Quit\nChoice: ", showAll ? "Show All" : "Show Latest Only");
        ...
        switch (choice) {
            ...
            case '8':
                while (objectList) {
                    GraphicalObject *temp = objectList;
                    objectList = objectList->next;
                    free(temp);
                }
                nextObjectId = 1;
                showAll = 1; // Reset to Show All when cleared
                break;
            case '9':
                showAll = !showAll;
                break;
